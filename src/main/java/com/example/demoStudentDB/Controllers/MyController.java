...
public class MyController {
    ...
    public ModelAndView save(@RequestParam("id") int id,
                             @RequestParam("fname") String fname, @RequestParam("lname") String
                                     lname){
    ...
    public ModelAndView findByFN(@RequestParam("fname") String
                                         fname){
        ModelAndView mv= new ModelAndView("view");
        mv.addObject("students", sRepo.findByFname(fname));
        return mv;
    }
}
